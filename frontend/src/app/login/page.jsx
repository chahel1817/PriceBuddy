...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[#060b13] flex items-center justify-center p-4 sm:p-6 relative overflow-hidden">
            {/* Background elements */}
            <div className="absolute top-0 left-0 h-80 w-80 sm:w-[800px] sm:h-[800px] bg-brand-cyan/5 blur-[150px] rounded-full -z-10 -translate-x-1/3 -translate-y-1/3" />
            <div className="absolute bottom-0 right-0 h-72 w-72 sm:w-[600px] sm:h-[600px] bg-blue-600/5 blur-[150px] rounded-full -z-10 translate-x-1/3 translate-y-1/3" />
